...
<nav>
    <ul class="pagination">
        ...
        <?php while($arResult["nStartPage"] <= $arResult["nEndPage"]): ?>
            ...
            <?php elseif($arResult["nStartPage"] == 1 && ($arResult["bSavePage"] && $arResult["bSavePage"] == false)): // если ссылка на первую страницу ?>
                <li><a href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?php $arResult["nStartPage"]?></a></li>
            <?php else: ?>
